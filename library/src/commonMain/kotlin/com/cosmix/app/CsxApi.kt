...
import com.cosmix.app.mvvm.safe
import com.cosmix.app.syncproviders.SyncIdName
import com.cosmix.app.utils.*
import com.cosmix.app.utils.AppUtils.toJson
import com.cosmix.app.utils.AppUtils.tryParseJson
import com.cosmix.app.utils.Coroutines.atomicListOf
import com.cosmix.app.utils.Coroutines.mainWork
import com.cosmix.app.utils.SubtitleHelper.fromCodeToLangTagIETF
import com.cosmix.app.utils.SubtitleHelper.fromLanguageToTagIETF
...
@RequiresOptIn(
    message = "This API is only available on prerelease builds. " +
              "Using it will cause Cosmix stable to crash.",
...
object CsxHolder {
    ...
    val allProviders = atomicListOf<CsxApi>()
    ...
    var apis: AtomicList<CsxApi> = atomicListOf()
    var apiMap: Map<String, Int>? = null

    fun addPluginMapping(plugin: CsxApi) {
        apis.withLock {
            apis = apis + plugin
        }
        initMap(true)
    ...
    fun removePluginMapping(plugin: CsxApi) {
        apis.withLock {
    ...
    fun getApiFromNameNull(apiName: String?): CsxApi? {
    ...
    fun getApiFromUrlNull(url: String?): CsxApi? {
...
abstract class CsxApi {
     ...
     * Check [com.cosmix.app.utils.SubtitleHelper].
     *
     * See locales on:
...
fun CsxApi.fixUrlNull(url: String?): String? {
...
fun CsxApi.fixUrl(url: String): String {
    ...
    companion object {
        ...
        fun fromOld(value: Int?): Score? {
            ...
            if (value < 0 || value > 10000) {
                com.cosmix.api.Log.w(TAG, "old: $value ∉ [0, 10000]")
                return null
            }
        ...
        fun from(value: Int?, maxScore: Int): Score? {
            ...
            if (value < 0 || value > maxScore) {
                com.cosmix.api.Log.w(TAG, "fromInt: $value ∉ [0, $maxScore]")
                return null
            }
        ...
        fun from(value: Double?, maxScore: Int): Score? {
            ...
            if (value < 0.0 || value > maxScore) {
                com.cosmix.api.Log.w(TAG, "fromDouble: $value ∉ [0.0, $maxScore]")
                return null
            }
        ...
        fun from(value: Float?, maxScore: Int): Score? {
            ...
            if (value < 0.0 || value > maxScore) {
                com.cosmix.api.Log.w(TAG, "fromFloat: $value ∉ [0.0f, $maxScore]")
                return null
            }
...
// No `CsxApi.` to be able to use this in extractors
...
/**
 * For APIs using the mainUrl in the prefix for `CsxApi::load`,
 ...
 * ```
 */
fun CsxApi.updateUrl(url: String): String {
    try {
...
fun CsxApi.newTorrentSearchResponse(
    name: String,
    url: String,
...
fun CsxApi.newMovieSearchResponse(
    name: String,
    url: String,
...
fun CsxApi.newLiveSearchResponse(
    name: String,
    url: String,
...
fun CsxApi.newTvSeriesSearchResponse(
    name: String,
    url: String,
...
fun CsxApi.newAnimeSearchResponse(
    name: String,
    url: String,
...
suspend fun CsxApi.newTorrentLoadResponse(
    name: String,
    url: String,
    magnet: String? = null,
    torrent: String? = null,
...
suspend fun CsxApi.newAnimeLoadResponse(
    name: String,
    url: String,
    type: TvType,
...
suspend fun CsxApi.newLiveStreamLoadResponse(
    name: String,
    url: String,
    dataUrl: String,
...
suspend fun <T> CsxApi.newMovieLoadResponse(
    name: String,
    url: String,
    type: TvType,
    data: T?,
...
suspend fun CsxApi.newMovieLoadResponse(
    name: String,
    url: String,
    type: TvType,
    dataUrl: String,
...
suspend fun CsxApi.newTvSeriesLoadResponse(
    name: String,
    url: String,
    type: TvType,
